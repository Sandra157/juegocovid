...
public class PANELESCENARIO extends JPanel{
	...
	public PANELESCENARIO() {
		...
		//así tenemos la imagen que utilizamos como fondo del escenario
		...
		//vamos a añadir el tamaño del panel preferido
		setPreferredSize(new Dimension(WIDTH, HEIGHT));
				
	}
	
	//Ahora vamos a escribir la rutina para añadir los otros bichitos Covid
	
	public void AÑADIRBICHITOS(int b) {
	NCOVID = b;
